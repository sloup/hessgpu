...
public:
	...
	int			_dog_level_num; // hessian: number of scales
	int			_level_num;		// hessian: _level_num = _dog_level_num + 2
...
#if defined GPU_HESSIAN || defined GPU_SIFT_MODIFIED
	#define SIFT_KEYPOINT_ITEMS 6
#else
	#define SIFT_KEYPOINT_ITEMS 4
#endif // GPU_HESSIAN || GPU_SIFT_MODIFIED
